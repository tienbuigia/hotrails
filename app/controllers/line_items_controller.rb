class LineItemsController < ApplicationController
  ...
  def set_quote
    @quote = current_company.quotes.find_by(id: params[:quote_id])
  end

  def set_line_item_date
    @line_item_date = @quote.line_item_dates.find_by(id: params[:line_item_date_id])
  end

  def set_line_item
    @line_item = @line_item_date.line_items.find_by(id: params[:id])
  end
end
